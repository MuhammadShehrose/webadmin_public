                ...
                <div class="predefined_styles">
                    ...
                    <div class="swichermainleft">
                        ...
                        <div class="switch_section d-flex my-4">
                            <ul class="switch-buttons row">
                                <li class="col-md-6 mb-4">
                                    <button type="button" id="background14"
                                        class="bg-layf wscolorcode1 button-image"></button>
                                    <span class="d-block">Full-Width</span>
                                </li>
                                <li class="col-md-6 mb-4">
                                    <button type="button" id="background15"
                                        class="bg-laybx wscolorcode1 button-image"></button>
                    ...
                    <div class="swichermainleft">
                        ...
                        <div class="switch_section d-flex my-4">
                            <ul class="switch-buttons row">
                                <li class="col-md-6 mb-4">
                                    <a href="index.html" type="button" id="background18"
                                        class="bg-sided button-image wscolorcode1 default-menu"
                                        data-sidetheme="{{ asset('assets/admin/css/sidemenu.css') }}"></a>
                                    <span class="d-block">Default</span>
                                </li>
                                <li class="col-md-6 mb-4">
                                    <a type="button" class="bg-sideictxt button-image wscolorcode1 icontext-menu"
                                        href="index1.html" data-sidetheme="{{ asset('assets/admin/css/sidemenu-icontext.css') }}"></a>
                                    <span class="d-block">Icon-with Text</span>
                                </li>
                                <li class="col-md-6 d-block mx-auto">
                                    <button type="button" id="background20"
                                        class="bg-sideicon button-image wscolorcode1 sideicon-menu"
                                        data-sidetheme="{{ asset('assets/admin/css/sidemenu-icon.html') }}"></button>
                    ...
                    <div class="swichermainleft">
                        ...
                        <div class="switch_section d-flex my-4">
                            <ul class="switch-buttons row">
                                <li class="col-md-6 mb-4">
                                    <button type="button" id="background16"
                                        class="bg-left1 wscolorcode1 button-image"></button>
                                    <span class="d-block">Fixed</span>
                                </li>
                                <li class="col-md-6 mb-4">
                                    <button type="button" id="background17"
                                        class="bg-left1 wscolorcode1 button-image"></button>
