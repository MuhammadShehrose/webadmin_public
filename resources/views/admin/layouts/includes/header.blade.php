    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="/">
                <img src="{{ asset('assets/admin/images/brand/logo.png') }}" class="header-brand-img desktop-lgo" alt="Azea logo">
                <img src="{{ asset('assets/admin/images/brand/logo1.png') }}" class="header-brand-img dark-logo" alt="Azea logo">
                <img src="{{ asset('assets/admin/images/brand/favicon.png') }}" class="header-brand-img mobile-logo" alt="Azea logo">
                <img src="{{ asset('assets/admin/images/brand/favicon1.png') }}" class="header-brand-img darkmobile-logo" alt="Azea logo">
            </a>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                                        ...
                                                        <p class="fs-12 mb-1">All the best your template
                                                            awesome</p>
                                        ...
                                        <a class="dropdown-item border-bottom" href="#">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span
                                                        class="avatar avatar-md brround align-self-center cover-image"
                                                        data-image-src="{{ asset('assets/admin/images/users/2.jpg') }}"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                        ...
                                        <a class="dropdown-item border-bottom" href="#">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span
                                                        class="avatar avatar-md brround align-self-center cover-image"
                                                        data-image-src="{{ asset('assets/admin/images/users/3.jpg') }}"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                                        <span class="mb-1">Julian Kerr</span>
                                                        <p class="fs-12 mb-1">Just created a new blog post
                                                        </p>
                                                        <div class="fs-11 text-muted">
                                                            45 mintues ago
                                                        </div>
                                        ...
                                        <a class="dropdown-item border-bottom" href="#">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span
                                                        class="avatar avatar-md brround align-self-center cover-image"
                                                        data-image-src="{{ asset('assets/admin/images/users/6.jpg') }}"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <span
                                                        class="avatar avatar-md brround align-self-center cover-image"
                                                        data-image-src="{{ asset('assets/admin/images/users/7.jpg') }}"></span>
                                                </div>
                                                <div class="d-flex mt-1 mb-1">
                                                    <div class="ps-3">
                                                        <span class="mb-1 fs-13">Faith Dickens</span>
                                                        <p class="fs-12 mb-1">Please check your mail....
                                                        </p>
                                                        <div class="fs-11 text-muted">
                                                            4 days ago
                                                        </div>
                            ...
                            <div class="dropdown header-notify d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow  animated">
                                    ...
                                    <div class=" text-center p-2">
                                        <a href="#" class="btn btn-primary btn-md fs-13 btn-block">View
                                            All</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dropdown profile-dropdown d-flex">
                                <a href="javascript:void(0);" class="nav-link pe-0 leading-none"
                                    ...
                                    <span class="header-avatar1">
                                        <img src="{{ auth()->user()->image ? asset('storage/' . auth()->user()->image) : asset('assets/admin/images/users/avatar-300.png') }}" alt="img"
